...
function startMatchScoreScanner() {
  setInterval(() => {
    ...
    const jdContainer = document.querySelector("#jobDescriptionText, .jobsearch-JobComponent-description");
    ...
    chrome.runtime.sendMessage({
      ...
      if (response && response.ok && response.data) {
        ...
        const targetContainer = document.querySelector("#jobDescriptionText, .jobsearch-JobComponent-description");
        if (targetContainer) {
